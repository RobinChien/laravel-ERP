...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>通用碼:</strong>
                {!! Form::select('common_id',  $common_code, $product->common_id, array('class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>供應商:</strong>
                {!! Form::select('manufacturer_id', $manufacturer, $product->manufacturer_id, array('class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
